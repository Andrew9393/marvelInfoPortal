...
<svg xmlns="http://www.w3.org/2000/svg" style={{margin: 'auto', background: 'rgb(255, 255, 255)', display: 'block', shapeRendering: 'auto'}} width="197px" height="197px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
<g transform="rotate(0 50 50)">
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.9740259740259741s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.8812615955473099s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.7884972170686457s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.6957328385899815s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.6029684601113173s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.4174397031539889s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.3246753246753247s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.2319109461966605s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.1391465677179963s" repeatCount="indefinite"></animate>
  </rect>
  ...
  <rect x="27" y="34.5" rx="23" ry="0.5" width="46" height="1" fill="#189ad2">
    <animate attributeName="opacity" values="1;0" keyTimes="0;1" dur="1.0204081632653061s" begin="-0.0463821892393321s" repeatCount="indefinite"></animate>
  </rect>
